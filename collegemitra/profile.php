      ...
      <div class="card rounded-0 mt-3 border-primary">
        <div class="card-header border-primary">
          <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
              <a href="#profile" class="nav-link active font-weight-bold text-dark bg-light" data-toggle="tab">Profile</a>
            </li>
            <li class="nav-item">
              <a href="#editProfile" class="nav-link font-weight-bold text-dark bg-light" data-toggle="tab">Edit Profile</a>
            </li>
            <li class="nav-item">
              <a href="#changePass" class="nav-link font-weight-bold text-dark bg-light" data-toggle="tab">Change Password</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
            ...
            <div class="tab-pane container active" id="profile">
              <div class="card-deck">
                <div class="card border-primary">
                  ...
                  <div class="card-body">
                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>Name : </b><?= $cname; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>E-mail : </b><?= $cemail; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>Gender : </b><?= $cgender; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>JEE Mains Rank : </b><?= $cjee_rank; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>Phone : </b><?= $cphone; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>Registered On : </b><?= $reg_on; ?></p>

                    <p class="card-text p-2 m-2 rounded bg-light text-dark"><b>Premium Plan : </b><b style="color:red;"> <?= $premium; ?></b>
